...
@section('content')
    ...
    <div class=" container ">
        @if ($action == 'add')
            ...
            $form_action = '/'.env('ADMIN_URL').'/visit-places';
            ?>
        @else
            <?php 
            $title = 'Edit';
            ...
            $form_action = '/'.env('ADMIN_URL').'/visit-places/'.$item->id;
            ?>
        @endif
            ...
            <form class="form" method="POST" action="{{$form_action}}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="comment" type="text"  value="{{ $item_comment }}"  class="form-control {{ $errors->has('comment') ? 'is-invalid' : '' }}" name="comment" placeholder="comment"/>
